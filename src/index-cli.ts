...
export class CliApplication extends Application {
    ...
    protected generate(): any {
        ...
        program
            ...
            .option('--coverageTestThresholdFail [true|false]', 'If an error should be thrown when documentation threshold is not met (default true)')
        ...
        if (program.coverageTestThresholdFail) {
            this.configuration.mainData.coverageTestThresholdFail = (program.coverageTestThresholdFail === 'true') ?
                true : COMPODOC_DEFAULTS.coverageTestThresholdFail;
        }
